...
add_action( 'storefront_header', 'storefront_site_branding',			60 );
...
add_action( 'storefront_header', 'storefront_product_categories',   100 );
...
add_action( 'homepage', 'storefront_featured_products',     20 );
add_action( 'homepage', 'storefront_popular_products',      30 );
add_action( 'homepage', 'storefront_recent_products',		40 );
// add_action( 'homepage', 'storefront_on_sale_products',		50 );
